...
class Config(object):
    ...
    def default_config(self):
        self.dict = {
            ...
            "uav_speed": {'carrier': 10, 'uav': 20},  # 假设车可以一边移动一边收集
            "uav_height": 100,
            "channel_num": 5,

            # PoI
            "update_num": {'carrier': 5, 'uav': 10},
            "collect_range": {'carrier': 250, 'uav': 300},
            "limit_range": {'carrier': 250, 'uav': 500},
            "rate_threshold": {'carrier': 1, 'uav': 1},
            "user_data_amount": 40,  # 1080P 2Mbps * 20s = 40
            "poi_init_data": 20,
            "poi_decision_mode":False,
            "near_selection_mode":False,
            "two_stage_mode":False,
            "rl_greedy_reward":False,
            "poi_in_obs_num":-1,
